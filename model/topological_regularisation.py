"""
    ...
    credit to Moor, Michael, et al. "Topological autoencoders." International conference on machine learning. PMLR, 2020.m
...
class TopologicallyRegularizedAutoencoder(AutoencoderModel):
    ...
    def _compute_distance_matrix(x, p=2):
        ...
        Args:
            x (tensor): represents the matrix
            p (int, optional): the lesbegue value for the underlying vector space
            of the points
